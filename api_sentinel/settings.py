"""
Django settings for api_sentinel project.
...
SECRET_KEY = 'django-insecure-v9x#-t8)l^yt3!-nwmrgn-4_s@w)t+*va&bdgl0r^2!f)m(nbh'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'api_sentinel_db'),
...
# --- Email Configuration ---
# Use the console backend during local development so password resets are printed to the terminal
